...
namespace CarParkPrototype
{
    public partial class Form1 : Form
    {
        ...
        string passPark;
        private string[] floor2pass = { "0", "0", "0", "0" };
        ...
        private void btbRegConfirm_Click(object sender, EventArgs e)
        {
            ...
            if (!txtbxReg.Text.Length.Equals(7))
                txtInstructions.Text = "Please enter valid registration";
            else if (leave)
            {
                RegNO = txtbxReg.Text;
        ...
        {
            if (!txtbxPin.Text.Length.Equals(4))
                txtInstructions.Text = "Please enter valid password";
            else if (leave)
            {
                passPark = txtbxPin.Text;
                btnConfirmSpace.Visible = true;
            }
            else if (Attempts < 2)
            {
                if ((parkingSpace > 5) && (parkingSpace <= 8))
                {
                    passPark = txtbxPin.Text;
                    if (passPark == floor2pass[parkingSpace - 5])
                    {
                        grbxPin.Enabled = false;
                        txtInstructions.Text = "Password Accepted ";
                        txtbxPin.Text = "";
                        btnConfirmLeave.Visible = true;
                    }
                    else
                    {
                        txtInstructions.Text = "Password Not found " + (Attempts + 1);
                        txtbxPin.Text = "";
                    }
                }
            ...
            else
            {
                ...
                if ((parkingSpace > 5) && (parkingSpace <= 8))
                {
                    floor1[parkingSpace - 5] = true;
                    floor1Reg[parkingSpace - 5] = "0";
                }
